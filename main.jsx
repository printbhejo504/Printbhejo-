...
async function mountModernConverter(){
  ...
  }catch(error){console.error("PrintBhejo converter tools failed to load:",error);slot.remove();}
  finally{converterMounting=false;}
}
